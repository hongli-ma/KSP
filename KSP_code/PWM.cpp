...
/* read test data */
	...
	ofstream fout("pwm_example_output.txt");
	...
	for(int j=0;j<15;++j)
	{
		for(int k=0;k<342;++k)
		{
			...
			default:
               ...
               double aaver=acount/241;//+aa_bp[0]*0.01;
		       double caver=ccount/241;//+aa_bp[1]*0.01;
		       double daver=dcount/241;//+aa_bp[2]*0.01;
		       double eaver=ecount/241;//+aa_bp[3]*0.01;
		       double faver=fcount/241;//+aa_bp[4]*0.01;
		       double gaver=gcount/241;//+aa_bp[5]*0.01;
		       double haver=hcount/241;//+aa_bp[6]*0.01;
		       double iaver=icount/241;//+aa_bp[7]*0.01;
		       double kaver=icount/241;//+aa_bp[8]*0.01;
		       double laver=lcount/241;//+aa_bp[9]*0.01;
		       double maver=mcount/241;//+aa_bp[10]*0.01;
		       double naver=ncount/241;//+aa_bp[11]*0.01;
		       double paver=pcount/241;//+aa_bp[12]*0.01;
		       double qaver=qcount/241;//+aa_bp[13]*0.01;
		       double raver=rcount/241;//+aa_bp[14]*0.01;
		       double saver=scount/241;//+aa_bp[15]*0.01;
		       double taver=tcount/241;//+aa_bp[16]*0.01;
		       double vaver=vcount/241;//+aa_bp[17]*0.01;
		       double waver=wcount/241;//+aa_bp[18]*0.01;
		       double yaver=ycount/241;//+aa_bp[19]*0.01;
